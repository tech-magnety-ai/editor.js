...
Element.prototype.scrollIntoViewIfNeeded ||
  (Element.prototype.scrollIntoViewIfNeeded = function (r) {
    ...
    const e = this.parentNode,
      ...
      n =
        this.offsetTop - e.offsetTop + this.clientHeight - o >
    ...
    (s || n) &&
      ...
      (a || l) &&
        ...
        (e.scrollLeft =
          ...
          i +
          this.clientWidth / 2),
      (s || n || a || l) && !r && this.scrollIntoView(c);
  });
...
function kt(r) {
  return (
    (r > 47 && r < 58) || // number keys
    r === 32 ||
    r === 13 || // Space bar & return key(s)
    ...
    return (
      ...
      u <= 0 || u > e
        ? (n && (clearTimeout(n), (n = null)),
          ...
          (s = r.apply(o, i)),
          n || (o = i = null))
        : !n && t.trailing !== !1 && (n = setTimeout(l, u)),
      s
    );
  };
}
...
function $e(r, ...e) {
  ...
  if (D(r) && D(t))
    for (const o in t)
      D(t[o])
        ? (r[o] || Object.assign(r, { [o]: {} }), $e(r[o], t[o]))
...
function Le(r) {
  ...
  return (
    (r = r
      ...
      .replace(/\+/gi, " + ")),
    e.mac
      ? (r = r.replace(/ctrl|cmd/gi, "⌘").replace(/alt/gi, "⌥"))
      : (r = r.replace(/cmd/gi, "Ctrl").replace(/windows/gi, "WIN")),
    r
  );
}
function po(r) {
...
class d {
  ...
  static prepend(e, t) {
    Array.isArray(t)
      ? ((t = t.reverse()), t.forEach((o) => e.prepend(o)))
      : e.prepend(t);
  }
  /**
  ...
  static findAllInputs(e) {
    return vt(e.querySelectorAll(d.allInputsSelector)).reduce(
      (t, o) =>
        d.isNativeInput(o) || d.containsOnlyInlineElements(o)
          ? [...t, o]
          : [...t, ...d.getDeepestBlockElements(o)],
      []
    );
  }
  /**
  ...
  static getDeepestBlockElements(e) {
    return d.containsOnlyInlineElements(e)
      ...
      : Array.from(e.children).reduce(
          (t, o) => [...t, ...d.getDeepestBlockElements(o)],
          []
        );
  }
  /**
  ...
  yt = class ne {
    ...
    static getNamespace(e) {
      return e
        .split(".")
        .reduce(
          (o, i) => (!o || !Object.keys(o).length ? {} : o[i]),
          ne.currentDictionary
        );
    }
  };
...
class ye {
  ...
  once(e, t) {
    ...
    const o = (i) => {
      const s = t(i),
        n = this.subscribers[e].indexOf(o);
...
class Ee {
  ...
  off(e, t, o, i) {
    ...
    s.forEach((n, a) => {
      ...
      l > -1 &&
        ...
        n.element.removeEventListener(n.eventType, n.handler, n.options));
    });
  }
  /**
  ...
  findAll(e, t, o) {
    ...
    return (
      e && t && o
        ? (i = s.filter((n) => n.eventType === t && n.handler === o))
        : e && t
        ? (i = s.filter((n) => n.eventType === t))
        : (i = s),
      i
    );
  }
  ...
  constructor({ config: e, eventsDispatcher: t }) {
    if (
      ...
      (this.readOnlyMutableListeners = {
         ...
         */
        on: (o, i, s, n = !1) => {
          this.mutableListenerIds.push(this.listeners.on(o, i, s, n));
        },
        /**
...
class m {
  ...
  static isSelectionAtEditor(e) {
    ...
    let o = null;
    return (
      t && t instanceof Element && (o = t.closest(`.${m.CSS.editorZone}`)),
  ...
  static get rect() {
    ...
    if (e && e.type !== "Control")
      return (
        ...
        (o.x = t.boundingLeft),
        (o.y = t.boundingTop),
        (o.width = t.boundingWidth),
        (o.height = t.boundingHeight),
        o
      );
    ...
    if (
      ...
      t.getBoundingClientRect && (o = t.getBoundingClientRect()),
      o.x === 0 && o.y === 0)
    ) {
      ...
      : ([
          ...
          for (
            ...
            !(
              a.tagName === e &&
              ((s = a),
              t && a.classList && !a.classList.contains(t) && (s = null),
              s)
            );
...
function yo(r, e) {
  ...
  return !!(
    e.contains(o) ||
    (t === "childList" &&
      (Array.from(i).some((l) => l === e) ||
        Array.from(s).some((l) => l === e)))
  );
}
const Ke = "redactor dom changed",
  Bt = "block changed",
  Tt = "fake cursor is about to be toggled",
  Ct = "fake cursor have been set",
  ke = "editor mobile layout toggled";
function Se(r, e) {
  if (!r.tool.conversionConfig) return !1;
...
var Z = /* @__PURE__ */ ((r) => (
  (r.APPEND_CALLBACK = "appendCallback"),
  (r.RENDERED = "rendered"),
  (r.MOVED = "moved"),
  (r.UPDATED = "updated"),
  (r.REMOVED = "removed"),
...
class R extends ye {
   ...
   */
  constructor(
    { id: e = fo(), data: t, tool: o, api: i, readOnly: s, tunesData: n },
    a
  ) {
    super(),
      (this.cachedInputs = []),
      (this.toolRenderedElement = null),
      (this.tunesInstances = /* @__PURE__ */ new Map()),
      (this.defaultTunesInstances = /* @__PURE__ */ new Map()),
        ...
        c || u
          ...
          : (h = !(
              ...
              l.every((b) => {
                ...
                return [...Array.from(p), ...Array.from(k), L].some(
                  (S) => (
                    d.isElement(S) || (S = S.parentElement),
      ...
      (this.blockAPI = new oe(this)),
      (this.tool = o),
      (this.toolInstance = o.create(t, this.blockAPI, s)),
      (this.tunes = o.tunes),
      this.composeTunes(n),
  ...
  set selected(e) {
    ...
    (t || o) &&
      ((i = this.editorEventBus) == null || i.emit(Tt, { state: e }),
      t ? m.addFakeCursor() : m.removeFakeCursor(this.holder),
      (s = this.editorEventBus) == null || s.emit(Ct, { state: e }));
  }
  /**
    ...
    const e = document.createElement("div"),
      ...
      o =
        typeof this.toolInstance.renderSettings == "function"
          ...
          : [],
      { items: i, htmlElement: s } = this.getTunesDataSegregated(o);
    return (
      s !== void 0 && e.appendChild(s),
      [...this.tunesInstances.values(), ...this.defaultTunesInstances.values()]
        .map((a) => a.render())
        .forEach((a) => {
          const { items: l, htmlElement: c } = this.getTunesDataSegregated(a);
  ...
  updateCurrentInput() {
    this.currentInput =
      d.isNativeInput(document.activeElement) || !m.anchorNode
  ...
  destroy() {
    this.unwatchBlockMutations(),
      ...
      super.destroy(),
      M(this.toolInstance.destroy) && this.toolInstance.destroy();
  }
  /**
  ...
  addInputEvents() {
    this.inputs.forEach((e) => {
      e.addEventListener("focus", this.handleFocus),
        d.isNativeInput(e) && e.addEventListener("input", this.didMutated);
    });
  }
  /**
  ...
  removeInputEvents() {
    this.inputs.forEach((e) => {
      e.removeEventListener("focus", this.handleFocus),
        d.isNativeInput(e) && e.removeEventListener("input", this.didMutated);
    });
  }
  /**
  ...
  watchBlockMutations() {
    ...
    (this.redactorDomChangedCallback = (t) => {
      ...
      (e = this.editorEventBus) == null ||
        e.on(Ke, this.redactorDomChangedCallback);
  }
  /**
  ...
  unwatchBlockMutations() {
    var e;
    (e = this.editorEventBus) == null ||
      e.off(Ke, this.redactorDomChangedCallback);
  }
  /**
...
class Bo extends y {
  constructor() {
    super(...arguments),
      ...
      (this.convert = (e, t, o) => {
        var h, f;
        const { BlockManager: i, Tools: s } = this.Editor,
          n = i.getBlockById(e);
        if (!n) throw new Error(`Block with id "${e}" not found`);
        const a = s.blockTools.get(n.name),
          l = s.blockTools.get(t);
        if (!l) throw new Error(`Block Tool with type "${t}" not found`);
        const c =
            ((h = a == null ? void 0 : a.conversionConfig) == null
              ? void 0
              : h.export) !== void 0,
          u = ((f = l.conversionConfig) == null ? void 0 : f.import) !== void 0;
        if (c && u) i.convert(n, t, o);
        else {
          const b = [c ? !1 : le(n.name), u ? !1 : le(t)]
            .filter(Boolean)
            .join(" and ");
          throw new Error(
            `Conversion from "${n.name}" to "${t}" is not possible. ${b} tool(s) should provide a "conversionConfig"`
          );
        }
      }),
      (this.insertMany = (
        ...
        const o = e.map(({ id: i, type: s, data: n }) =>
        ...
        return (
          this.Editor.BlockManager.insertMany(o, t), o.map((i) => new oe(i))
        );
      });
  }
  /**
  ...
  getById(e) {
    const t = this.Editor.BlockManager.getBlockById(e);
    return t === void 0
      ? (X("There is no block with id `" + e + "`", "warn"), null)
      : new oe(t);
  }
  /**
   ...
   */
  stretchBlock(e, t = !0) {
    We(!0, "blocks.stretchBlock()", "BlockAPI");
      ...
      (this.setToFirstBlock = (
        ...
        this.Editor.BlockManager.firstBlock
          ? (this.Editor.Caret.setToBlock(
            ...
            !0)
          : !1),
      (this.setToLastBlock = (e = this.Editor.Caret.positions.DEFAULT, t = 0) =>
      ...
      (this.setToPreviousBlock = (
        ...
        this.Editor.BlockManager.previousBlock
          ? (this.Editor.Caret.setToBlock(
            ...
            !0)
          : !1),
      (this.setToNextBlock = (e = this.Editor.Caret.positions.DEFAULT, t = 0) =>
        this.Editor.BlockManager.nextBlock
          ? (this.Editor.Caret.setToBlock(
            ...
            !0)
          : !1),
      (this.setToBlock = (e, t = this.Editor.Caret.positions.DEFAULT, o = 0) =>
        this.Editor.BlockManager.blocks[e]
          ? (this.Editor.Caret.setToBlock(
              this.Editor.BlockManager.blocks[e],
              t,
              o
    ...
    return (function (t) {
      ...
      return (
        ...
        (i.t = function (s, n) {
          if (
            (1 & n && (s = i(s)),
            8 & n || (4 & n && typeof s == "object" && s && s.__esModule))
          )
            return s;
                  ...
                  if (c && typeof btoa == "function") {
                    var f =
                        ...
                        "/*# sourceMappingURL=data:application/json;charset=utf-8;base64," +
                          btoa(
                            unescape(encodeURIComponent(JSON.stringify(p)))
                          ) +
                          " */"),
                      b = h.sources.map(function (k) {
      ...
      function (t, o, i) {
        ...
        function p(v, g) {
          for (var w = 0; w < v.length; w++) {
            ...
            if (I) {
              I.refs++;
              for (var T = 0; T < I.parts.length; T++) I.parts[T](E.parts[T]);
              for (; T < E.parts.length; T++) I.parts.push(z(E.parts[T], g));
            } else {
              var N = [];
              for (T = 0; T < E.parts.length; T++) N.push(z(E.parts[T], g));
        ...
        function k(v, g) {
          for (var w = [], E = {}, I = 0; I < v.length; I++) {
            var T = v[I],
              ...
              B = { css: T[1], media: T[2], sourceMap: T[3] };
        ...
        function L(v, g) {
          ...
          if (v.insertAt === "top")
            E
              ? E.nextSibling
                ? w.insertBefore(g, E.nextSibling)
                : w.appendChild(g)
              : w.insertBefore(g, w.firstChild),
              f.push(g);
          else if (v.insertAt === "bottom") w.appendChild(g);
          else {
...
`);
        ...
        function S(v) {
          ...
          return (
            v.attrs.type === void 0 && (v.attrs.type = "text/css"),
            Q(g, v.attrs),
            L(v, g),
            g
          );
        ...
        function z(v, g) {
          ...
          if (g.transform && v.css) {
            if (!(T = g.transform(v.css))) return function () {};
            v.css = T;
          }
          if (g.singleton) {
            var N = h++;
            (w = u || (u = S(g))),
              (E = ue.bind(null, w, N, !1)),
              (I = ue.bind(null, w, N, !0));
          } else
            v.sourceMap &&
            typeof URL == "function" &&
            ...
            typeof btoa == "function"
              ? ((w = (function (B) {
                  ...
                  return (
                    B.attrs.type === void 0 && (B.attrs.type = "text/css"),
                    (B.attrs.rel = "stylesheet"),
                    Q($, B.attrs),
                    L(B, $),
                    $
                  );
                ...
                (E = function (B, $, pe) {
                  var te = pe.css,
                    _e = pe.sourceMap,
                    to = $.convertToAbsoluteUrls === void 0 && _e;
                  ($.convertToAbsoluteUrls || to) && (te = b(te)),
                    _e &&
                      (te +=
                        `
/*# sourceMappingURL=data:application/json;base64,` +
                        btoa(unescape(encodeURIComponent(JSON.stringify(_e)))) +
                        " */");
                  var oo = new Blob([te], { type: "text/css" }),
                    rt = B.href;
                  (B.href = URL.createObjectURL(oo)),
...
`)
        ...
        function ue(v, g, w, E) {
          var I = w ? "" : E.css;
          if (v.styleSheet) v.styleSheet.cssText = ee(g, I);
          else {
            var T = document.createTextNode(I),
              N = v.childNodes;
            N[g] && v.removeChild(N[g]),
              N.length ? v.insertBefore(T, N[g]) : v.appendChild(T);
          }
        }
      },
      function (t, o) {
        t.exports = function (i) {
          ...
          var n = s.protocol + "//" + s.host,
            a = n + s.pathname.replace(/\/[^\/]*$/, "/");
          return i.replace(
            /url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi,
            function (l, c) {
              var u,
        ...
        t.exports =
          ...
          (f = "cdx-notify__btns-wrapper"),
          {
            alert: (b = function (p) {
              ...
              return (
                k.classList.add(n),
                S && k.classList.add(n + "--" + S),
                (k.innerHTML = A),
                L.classList.add(a),
                L.addEventListener("click", k.remove.bind(k)),
                k.appendChild(L),
                k
              );
            }),
            confirm: function (p) {
              ...
              return (
                L.classList.add(f),
                (A.innerHTML = p.okText || "Confirm"),
                (S.innerHTML = p.cancelText || "Cancel"),
                A.classList.add(h),
                S.classList.add(h),
                A.classList.add(l),
                S.classList.add(c),
                ...
                j && typeof j == "function" && A.addEventListener("click", j),
                A.addEventListener("click", k.remove.bind(k)),
                S.addEventListener("click", k.remove.bind(k)),
                L.appendChild(A),
                L.appendChild(S),
                k.appendChild(L),
                k
            ...
            prompt: function (p) {
              ...
              return (
                L.classList.add(f),
                (A.innerHTML = p.okText || "Ok"),
                A.classList.add(h),
                A.classList.add(l),
                S.classList.add(u),
                p.placeholder && S.setAttribute("placeholder", p.placeholder),
                p.default && (S.value = p.default),
                p.inputType && (S.type = p.inputType),
                z && typeof z == "function" && Q.addEventListener("click", z),
                j &&
                  typeof j == "function" &&
        ...
        if (p)
          do {
            if (p.nodeType === Node.TEXT_NODE)
              if (
                p.data.trim() === "" &&
                ((p.previousElementSibling && i(p.previousElementSibling)) ||
                  (p.nextElementSibling && i(p.nextElementSibling)))
              ) {
...
class jo extends y {
  ...
  save() {
    ...
    return this.Editor.ReadOnly.isEnabled
      ? (X(e, "warn"), Promise.reject(new Error(e)))
      ...
      function (t, o, i) {
        ...
        class s {
          ...
          show(a, l, c) {
            ...
            if (
              (u.hidingDelay && (this.hidingDelay = u.hidingDelay),
...
class J {
    ...
    (this.iterator = null),
      ...
      (this.onKeyDown = (t) => {
        if (this.isEventReadyForHandling(t))
          switch (
            (J.usedKeys.includes(t.keyCode) && t.preventDefault(), t.keyCode)
          ) {
            case x.TAB:
      ...
      (this.iterator = new fe(e.items, e.focusedItemClass)),
      (this.activateCallback = e.activateCallback),
      (this.allowedKeys = e.allowedKeys || J.usedKeys);
  }
  /**
   ...
   */
  static get usedKeys() {
    return [x.TAB, x.LEFT, x.RIGHT, x.ENTER, x.UP, x.DOWN];
  }
  /**
...
function he(r) {
  return (e, t) =>
    [[r, e].filter((i) => !!i).join(ui), t].filter((i) => !!i).join(pi);
}
const W = he("ce-popover-item"),
  _ = {
    container: W(),
...
class Ne extends Nt {
  ...
  constructor(e) {
    super(),
      ...
      (this.onErrorAnimationEnd = () => {
        var t, o;
        (t = this.nodes.icon) == null || t.classList.remove(_.wobbleAnimation),
          (o = this.nodes.icon) == null ||
            o.removeEventListener("animationend", this.onErrorAnimationEnd);
      }),
      (this.params = e),
      (this.nodes.root = this.make(e));
  }
  /**
  ...
  get isFocused() {
    return this.nodes.root === null
      ? !1
      : this.nodes.root.classList.contains(_.focused);
  }
  /**
  ...
  get children() {
    var e;
    return "children" in this.params &&
  ...
  make(e) {
    ...
    return (
      e.name && (t.dataset.itemName = e.name),
      (this.nodes.icon = d.make("div", [_.icon, _.iconTool], {
        innerHTML: e.icon || si,
      })),
      ...
      e.secondaryLabel &&
        t.appendChild(
          d.make("div", _.secondaryTitle, {
            textContent: e.secondaryLabel,
          })
        ),
      this.children.length > 0 &&
        t.appendChild(
          d.make("div", [_.icon, _.iconChevronRight], {
            innerHTML: ti,
          })
        ),
      e.isActive && t.classList.add(_.active),
      e.isDisabled && t.classList.add(_.disabled),
      t
    );
  }
  /**
  ...
  enableConfirmationMode(e) {
    ...
    (this.nodes.root.innerHTML = o.innerHTML),
      this.nodes.root.classList.add(_.confirmationState),
  ...
  disableConfirmationMode() {
    ...
    (this.nodes.root.innerHTML = e.innerHTML),
      this.nodes.root.classList.remove(_.confirmationState),
      (this.confirmationState = null),
      this.disableSpecialHoverAndFocusBehavior();
  }
  /**
  ...
  enableSpecialHoverAndFocusBehavior() {
    var e, t, o;
    (e = this.nodes.root) == null || e.classList.add(_.noHover),
      (t = this.nodes.root) == null || t.classList.add(_.noFocus),
      (o = this.nodes.root) == null ||
        o.addEventListener("mouseleave", this.removeSpecialHoverBehavior, {
          once: !0,
        });
  }
  /**
  ...
  animateError() {
    ...
    ((e = this.nodes.icon) != null &&
      e.classList.contains(_.wobbleAnimation)) ||
      ((t = this.nodes.icon) == null || t.classList.add(_.wobbleAnimation),
      (o = this.nodes.icon) == null ||
        o.addEventListener("animationend", this.onErrorAnimationEnd));
  }
}
const Re = he("ce-popover-item-separator"),
  De = {
    container: Re(),
    line: Re("line"),
...
class fi extends ye {
  ...
  constructor({ items: e, placeholder: t }) {
    super(),
      (this.listeners = new Ee()),
      (this.items = e),
      (this.wrapper = d.make("div", Fe.wrapper));
...
class Rt extends ye {
    ...
    super(),
      ...
      (this.onSearch = (t) => {
        ...
        this.items.forEach((s) => {
          let n = !1;
          s instanceof Ne
            ? (n = !t.items.includes(s))
            : s instanceof pt && (n = i || !o),
            s.toggleHidden(n);
        }),
          this.toggleNothingFoundMessage(i),
          this.toggleCustomContent(o);
      }),
      ...
      (this.nodes = {}),
      (this.nodes.popoverContainer = d.make("div", [O.popoverContainer])),
      (this.nodes.nothingFoundMessage = d.make("div", [O.nothingFoundMessage], {
        textContent: this.messages.nothingFound,
      })),
      this.nodes.popoverContainer.appendChild(this.nodes.nothingFoundMessage),
      (this.nodes.items = d.make("div", [O.items])),
      this.items.forEach((t) => {
        const o = t.getElement();
        o !== null && this.nodes.items.appendChild(o);
      }),
      this.nodes.popoverContainer.appendChild(this.nodes.items),
      this.listeners.on(this.nodes.popoverContainer, "click", (t) =>
        this.handleClick(t)
      ),
      (this.nodes.popover = d.make("div", [O.popover, this.params.class])),
      this.nodes.popover.appendChild(this.nodes.popoverContainer),
      e.customContent && this.addCustomContent(e.customContent),
   ...
   */
  show() {
    this.nodes.popover.classList.add(O.popoverOpened),
   ...
   */
  hide() {
    this.nodes.popover.classList.remove(O.popoverOpened),
      this.nodes.popover.classList.remove(O.popoverOpenTop),
      this.itemsInteractive.forEach((e) => e.reset()),
   ...
   */
  addCustomContent(e) {
    (this.nodes.customContent = e),
      this.nodes.customContent.classList.add(O.customContent),
      this.nodes.popoverContainer.insertBefore(
        e,
        this.nodes.popoverContainer.firstChild
      );
  ...
  handleClick(e) {
    ...
    if (t !== void 0 && !t.isDisabled) {
      ...
      this.itemsInteractive.filter((o) => o !== t).forEach((o) => o.reset()),
        t.handleClick(),
        this.toggleItemActivenessIfNeeded(t),
        t.closeOnActivate && this.hide();
    }
  }
  /**
  ...
  toggleNothingFoundMessage(e) {
    this.nodes.nothingFoundMessage.classList.toggle(
      O.nothingFoundMessageDisplayed,
      e
    );
  }
  /**
  ...
  toggleCustomContent(e) {
    ...
    (t = this.nodes.customContent) == null ||
      t.classList.toggle(O.customContentHidden, e);
  }
  /**
...
var gi = Object.defineProperty,
  ...
  bi = (r, e, t, o) => {
    for (
      var i = o > 1 ? void 0 : o ? mi(e, t) : e, s = r.length - 1, n;
      s >= 0;
      s--
    )
...
const Dt = class Pt extends Rt {
  ...
  constructor(e) {
    ...
    super(e),
      ...
      this.nestingLevel > 0 &&
        this.nodes.popover.classList.add(O.popoverNested),
      ...
      this.nodes.popoverContainer !== null &&
        this.listeners.on(this.nodes.popoverContainer, "mouseover", (o) =>
          this.handleHover(o)
        ),
      (this.flipper = new J({
        items: this.flippableElements,
        focusedItemClass: _.focused,
        allowedKeys: [x.TAB, x.UP, x.DOWN, x.ENTER],
      })),
      this.flipper.onFlip(this.onFlip),
      (t = this.search) == null || t.on(xe.Search, this.handleSearch);
  }
  /**
  ...
  show() {
    this.nodes.popover.style.setProperty(
      ...
      this.shouldOpenBottom ||
        this.nodes.popover.classList.add(O.popoverOpenTop),
      this.shouldOpenRight ||
        this.nodes.popover.classList.add(O.popoverOpenLeft),
      super.show(),
  ...
  get shouldOpenRight() {
    ...
    const e = this.nodes.popover.getBoundingClientRect(),
      ...
      i = e.right + o,
      s = e.left - o,
      n = Math.min(window.innerWidth, t.right);
    return s < t.left || i <= n;
  }
  get size() {
    var i;
    ...
    (t.style.visibility = "hidden"),
      ...
      (t.style.top = "-1000px"),
      t.classList.add(O.popoverOpened),
      (i = t.querySelector("." + O.popoverNested)) == null || i.remove(),
      document.body.appendChild(t);
    const o = t.querySelector("." + O.popoverContainer);
    return (
      (e.height = o.offsetHeight), (e.width = o.offsetWidth), t.remove(), e
    );
  }
  /**
  ...
  showNestedPopoverForItem(e) {
    ...
    const o = e.getElement(),
      ...
      s = this.offsetTop + i;
    t.style.setProperty("--trigger-item-top", s + "px"),
      t.style.setProperty(
        "--nesting-level",
  ...
  handleHover(e) {
    ...
    t !== void 0 &&
      ...
      (this.destroyNestedPopoverIfExists(),
      (this.previouslyHoveredItem = t),
      t.children.length !== 0 && this.showNestedPopoverForItem(t));
  }
};
bi([de], Dt.prototype, "size", 1);
let Ft = Dt;
const Ht = class me {
  constructor() {
  ...
  unlock() {
    Ye
      ? this.unlockHard()
      : document.body.classList.remove(me.CSS.scrollLocked);
  }
  /**
   ...
   */
  unlockHard() {
    document.body.classList.remove(me.CSS.scrollLockedHard),
...
class vi {
  ...
  constructor({ text: e, onBackButtonClick: t }) {
    (this.listeners = new Ee()),
      ...
      (this.nodes.backButton.innerHTML = ei),
...
class zt extends Rt {
  ...
  constructor(e) {
    super(e),
      (this.scrollLocker = new ki()),
      (this.history = new xi()),
      (this.isHidden = !0),
      (this.nodes.overlay = d.make("div", [O.overlay, O.overlayHidden])),
   ...
   */
  show() {
    this.nodes.overlay.classList.remove(O.overlayHidden),
      super.show(),
  ...
  hide() {
    this.isHidden ||
      (super.hide(),
      this.nodes.overlay.classList.add(O.overlayHidden),
...
class wi extends y {
  constructor() {
    super(...arguments),
      (this.opened = !1),
      (this.selection = new m()),
      (this.popover = null),
      (this.close = () => {
        this.opened &&
          ((this.opened = !1),
          m.isAtEditor || this.selection.restore(),
          ...
          this.popover &&
            (this.popover.off(ie.Close, this.onPopoverClose),
  ...
  make() {
    (this.nodes.wrapper = d.make("div", [this.CSS.settings])),
      this.eventsDispatcher.on(ke, this.close);
  }
  /**
   * Destroys module
   */
  destroy() {
    this.removeAllNodes(),
      ...
      this.eventsDispatcher.off(ke, this.close);
  }
  /**
  ...
  async open(e = this.Editor.BlockManager.currentBlock) {
    ...
    (this.popover = new s({
      ...
      this.popover.on(ie.Close, this.onPopoverClose),
      (n = this.nodes.wrapper) == null || n.append(this.popover.getElement()),
      this.popover.show();
  }
  /**
  ...
  async getTunesItems(e, t, o) {
    ...
    return (
      ...
      i.push(...t),
      i.map((n) => this.resolveTuneAliases(n))
    );
  }
  /**
  ...
  async getConvertToItems(e) {
    const t = Array.from(this.Editor.Tools.blockTools.entries()),
      o = [],
      i = await e.data;
    return (
      t.forEach(([s, n]) => {
        ...
        !a ||
          ...
          (l = n.toolbox) == null ||
          l.forEach((c) => {
            if (K(c) || !c.icon) return;
            let u = !1;
            c.data !== void 0 ? (u = St(c.data, i)) : (u = s === e.name),
              !u &&
                o.push({
                  icon: c.icon,
                  title: c.title,
                  ...
                  onActivate: async () => {
                    ...
                    f.clearSelection(),
                      this.close(),
                      b.setToBlock(p, b.positions.END);
                  },
                });
          });
      }),
...
class Y extends y {
    ...
    this.filterTools(),
      ...
      window.requestAnimationFrame(() => {
        this.flipper.activate(
          this.tools
            .map((e) => e.button)
            .filter((e) => !e.classList.contains(Y.CSS.conversionToolHidden))
        ),
          this.flipper.focusFirst(),
          M(this.togglingCallback) && this.togglingCallback(!0);
      });
  }
  /**
  ...
  async replaceWithBlock(e, t) {
    ...
    o.convert(this.Editor.BlockManager.currentBlock, e, t),
      i.clearSelection(),
      this.close(),
      s.close(),
      window.requestAnimationFrame(() => {
  ...
  addTools() {
    ...
    Array.from(e.entries()).forEach(([t, o]) => {
      ...
      !i ||
        !i.import ||
        (s = o.toolbox) == null ||
        s.forEach((n) => this.addToolIfValid(t, n));
    });
  }
  /**
  ...
  addTool(e, t) {
    ...
    (o.dataset.tool = e),
      (i.innerHTML = t.icon),
      d.append(o, i),
      d.append(o, d.text(U.t(V.toolNames, t.title || le(e))));
    const s =
      (n = this.Editor.Tools.blockTools.get(e)) == null ? void 0 : n.shortcut;
    if (s) {
  ...
  async filterTools() {
    ...
    this.tools.forEach((i) => {
      ...
      (i.button.hidden = s),
        i.button.classList.toggle(Y.CSS.conversionToolHidden, s);
    });
  }
  /**
            ...
            n(l, [
              ...
              },
              {
                ...
                value: function (c) {
                  ...
                  var b,
                    p = !0;
                  for (b in this.keys) p = p && c.keyCode === l.keyCodes[b];
                  f && p && this.callback(c);
                },
              },
              {
...
var Ti = Object.defineProperty,
  ...
  jt = (r, e, t, o) => {
    for (
      var i = o > 1 ? void 0 : o ? Ci(e, t) : e, s = r.length - 1, n;
      s >= 0;
      s--
    )
      (n = r[s]) && (i = (o ? n(e, t, i) : n(i)) || i);
  ...
  Be = /* @__PURE__ */ ((r) => (
    (r.Opened = "toolbox-opened"),
    (r.Closed = "toolbox-closed"),
    (r.BlockAdded = "toolbox-block-added"),
    r
  ))(Be || {});
const Je = class $t extends ye {
  ...
  constructor({ api: e, tools: t, i18nLabels: o }) {
    super(),
      ...
      this.initPopover(),
      this.api.events.on(ke, this.handleMobileLayoutToggle);
  }
  /**
  ...
  destroy() {
    ...
    super.destroy(),
      ...
      (e = this.popover) == null || e.off(ie.Close, this.onPopoverClose),
      this.listeners.destroy(),
      this.api.events.off(ke, this.handleMobileLayoutToggle);
  }
  /**
  ...
  initPopover() {
    ...
    (this.popover = new e({
      ...
      this.popover.on(ie.Close, this.onPopoverClose),
      (t = this.nodes.toolbox) == null || t.append(this.popover.getElement());
  }
  /**
  ...
  get toolboxItemsToBeDisplayed() {
    ...
    return this.toolsToBeDisplayed.reduce(
      (t, o) => (
        Array.isArray(o.toolbox)
          ? o.toolbox.forEach((i) => {
              t.push(e(i, o));
            })
          : o.toolbox !== void 0 && t.push(e(o.toolbox, o)),
        t
      ),
      []
    );
  ...
  enableShortcutForTool(e, t) {
    ce.add({
      ...
      handler: (o) => {
        ...
        if (s)
          try {
            this.api.blocks.convert(s.id, e),
              window.requestAnimationFrame(() => {
  ...
  async insertNewBlock(e, t) {
    ...
    const a = this.api.blocks.insert(e, n, void 0, s, void 0, i.isEmpty);
    a.call(Z.APPEND_CALLBACK),
      this.api.caret.setToBlock(s),
      this.emit("toolbox-block-added", {
        block: a,
      }),
      this.api.toolbar.close();
  }
};
jt([de], Je.prototype, "toolsToBeDisplayed", 1);
jt([de], Je.prototype, "toolboxItemsToBeDisplayed", 1);
let Si = Je;
...
class Mi extends y {
  ...
  moveAndOpen(e = this.Editor.BlockManager.currentBlock) {
    ...
    const t = e.holder,
      ...
      n = parseInt(s.paddingTop, 10),
      a = t.offsetHeight;
    let l;
    o ? (l = t.offsetTop + a) : (l = t.offsetTop + n),
  ...
  async make() {
    ...
    const e = d.make("div");
    e.appendChild(document.createTextNode(U.ui(V.ui.toolbar.toolbox, "Add"))),
      e.appendChild(
    ...
    const t = d.make("div"),
      o = d.text(U.ui(V.ui.blockTunes.toggler, "Click to tune")),
      i = await Ii("Slash", "/");
    t.appendChild(o),
      t.appendChild(
        d.make("div", this.CSS.plusButtonShortcut, {
  ...
  makeToolbox() {
    return (
      ...
      this.toolboxInstance.on(Be.BlockAdded, ({ block: e }) => {
        const { BlockManager: t, Caret: o } = this.Editor,
          i = t.getBlockById(e.id);
        i.inputs.length === 0 &&
          (i === t.lastBlock
            ? (t.insertAtEnd(), o.setToBlock(t.lastBlock))
            : o.setToBlock(t.nextBlock));
      }),
...
var Ae = /* @__PURE__ */ ((r) => (
  ...
  Te = /* @__PURE__ */ ((r) => (
    (r.Shortcut = "shortcut"),
    (r.Toolbox = "toolbox"),
    (r.EnabledInlineTools = "inlineToolbar"),
    (r.EnabledBlockTunes = "tunes"),
    (r.Config = "config"),
    r
  ))(Te || {}),
  Yt = /* @__PURE__ */ ((r) => (
    (r.Shortcut = "shortcut"), (r.SanitizeConfig = "sanitize"), r
  ))(Yt || {}),
  re = /* @__PURE__ */ ((r) => (
    (r.IsEnabledLineBreaks = "enableLineBreaks"),
    (r.Toolbox = "toolbox"),
    (r.ConversionConfig = "conversionConfig"),
    (r.IsReadOnlySupported = "isReadOnlySupported"),
    (r.PasteConfig = "pasteConfig"),
    r
  ))(re || {}),
  Qe = /* @__PURE__ */ ((r) => (
    (r.IsInline = "isInline"), (r.Title = "title"), r
  ))(Qe || {}),
  Kt = /* @__PURE__ */ ((r) => ((r.IsTune = "isTune"), r))(Kt || {});
class et {
  /**
   * @class
...
class Li extends y {
  ...
  constructor({ config: e, eventsDispatcher: t }) {
    super({
      ...
      (this.opened = !1),
      (this.toolbarVerticalMargin = ae() ? 20 : 6),
    ...
    this.opened &&
      (this.Editor.ReadOnly.isEnabled ||
        ...
        Array.from(this.toolsInstances.entries()).forEach(([e, t]) => {
          ...
          o && ce.remove(this.Editor.UI.nodes.redactor, o),
            M(t.clear) && t.clear();
        }),
        this.reset(),
        (this.opened = !1),
  ...
  move() {
    const e = m.rect,
      ...
      o = {
        ...
        y:
          e.y +
          e.height - // + window.scrollY
          t.top +
          this.toolbarVerticalMargin,
      };
    o.x + this.width + t.x > this.Editor.UI.contentRect.right &&
      (o.x = this.Editor.UI.contentRect.right - this.width - t.x),
  ...
  allowedToShow() {
    ...
    const i = d.isElement(t.anchorNode)
      ? t.anchorNode
  ...
  addConversionToggler() {
    ...
    this.nodes.conversionToggler.appendChild(
      ...
      ae() === !1 &&
        ve(
          this.nodes.conversionToggler,
          U.ui(V.ui.inlineToolbar.converter, "Convert to"),
          {
            placement: "top",
            hidingDelay: 100,
          }
  ...
  async setConversionTogglerContent() {
    const { BlockManager: e } = this.Editor,
      ...
      s = i && i.export;
    (this.nodes.conversionToggler.hidden = !s),
  ...
  async addToolsFiltered(e = !0) {
    ...
    (this.nodes.buttons.innerHTML = ""),
      ...
      (this.toolsInstances = /* @__PURE__ */ new Map()),
      Array.from(o.tool.inlineTools.values()).forEach((i) => {
        this.addTool(i);
      }),
      e && this.Editor.ConversionToolbar.hasTools()
  ...
  addTool(e) {
    ...
    if (
      ((o.dataset.tool = e.name),
      this.nodes.buttons.appendChild(o),
      this.toolsInstances.set(e.name, t),
      M(t.renderActions))
    ) {
    ...
    const s = d.make("div"),
      n = U.t(V.toolNames, e.title || le(e.name));
    s.appendChild(d.text(n)),
      i &&
        s.appendChild(
  ...
  getToolShortcut(e) {
    ...
    return Array.from(i.keys()).includes(e)
      ? this.inlineTools[e][Yt.Shortcut]
      : o.shortcut;
  }
  /**
    ...
    ce.add({
      ...
      handler: (o) => {
        ...
        i &&
          ...
          (o.preventDefault(), this.toolClicked(e));
      },
  ...
  toolClicked(e) {
    ...
    e.surround(t),
      ...
      e.renderActions !== void 0 && this.flipper.deactivate();
  }
  /**
  ...
  get inlineTools() {
    const e = {};
    return (
      Array.from(this.Editor.Tools.inlineTools.entries()).forEach(([t, o]) => {
        e[t] = o.create();
      }),
      e
    );
...
class Ai extends y {
  ...
  keydown(e) {
    ...
    e.key === "/" && !e.ctrlKey && !e.metaKey && this.slashPressed(),
      e.code === "Slash" &&
        (e.ctrlKey || e.metaKey) &&
    ...
    t.anyBlockSelected &&
      t.copySelectedBlocks(e).then(() => {
        const s = o.removeSelectedBlocks(),
          n = o.insertDefaultBlockAtIndex(s, !0);
  ...
  tabPressed(e) {
    ...
    (e.shiftKey ? i.navigatePrevious(!0) : i.navigateNext(!0)) &&
      e.preventDefault();
  }
  /**
  ...
  enter(e) {
    ...
    if (
      t.currentBlock.tool.isLineBreaksEnabled ||
  ...
  mergeBlocks(e, t) {
    ...
    i.createShadow(e.pluginsContent),
      o.mergeBlocks(e, t).then(() => {
  ...
  arrowRightAndDown(e) {
    const t =
      J.usedKeys.includes(e.keyCode) && (!e.shiftKey || e.keyCode === x.TAB);
    ...
    if (
      e.keyCode === x.DOWN || (e.keyCode === x.RIGHT && !this.isRtl)
  ...
  arrowLeftAndUp(e) {
    if (this.Editor.UI.someToolbarOpened) {
      if (
        J.usedKeys.includes(e.keyCode) &&
        (!e.shiftKey || e.keyCode === x.TAB)
      )
        return;
    ...
    if (
      e.keyCode === x.UP || (e.keyCode === x.LEFT && !this.isRtl)
        ? this.Editor.Caret.navigatePrevious()
        : this.Editor.Caret.navigateNext()
    ) {
      e.preventDefault();
  ...
  needToolbarClosing(e) {
    const t = e.keyCode === x.ENTER && this.Editor.Toolbar.toolbox.opened,
      o = e.keyCode === x.ENTER && this.Editor.BlockSettings.opened,
      i = e.keyCode === x.ENTER && this.Editor.InlineToolbar.opened,
      s = e.keyCode === x.ENTER && this.Editor.ConversionToolbar.opened,
      n = e.keyCode === x.TAB;
...
class Ue {
  ...
  swap(e, t) {
    ...
    d.swap(this.blocks[e].holder, o.holder),
  ...
  move(e, t) {
    ...
    e > 0
      ...
      : this.insertToDOM(o, "beforebegin", n),
  ...
  insert(e, t, o = !1) {
    ...
    e > this.length && (e = this.length),
      o && (this.blocks[e].holder.remove(), this.blocks[e].call(Z.REMOVED));
    const i = o ? 1 : 0;
  ...
  removeAll() {
    (this.workingArea.innerHTML = ""),
      this.blocks.forEach((e) => e.call(Z.REMOVED)),
  ...
  insertToDOM(e, t, o) {
    t
      ? o.holder.insertAdjacentElement(t, e.holder)
...
class Ni extends y {
  ...
  composeBlock({ tool: e, data: t = {}, id: o = void 0, tunes: i = {} }) {
    const s = this.Editor.ReadOnly.isEnabled,
      n = this.Editor.Tools.blockTools.get(e),
      a = new R(
        {
          id: o,
          data: t,
  ...
  insert({
    ...
    return (
      n &&
        this.blockDidMutated(ft, this.getBlockByIndex(l), {
          index: l,
        }),
      this._blocks.insert(l, c, n),
      this.blockDidMutated(gt, c, {
        index: l,
      }),
      s
  ...
  async update(e, t) {
    ...
    return (
      this._blocks.replace(s, i),
      this.blockDidMutated(mt, i, {
        index: s,
      }),
      i
    );
  ...
  move(e, t = this.currentBlockIndex) {
    ...
    this._blocks.move(e, t),
      (this.currentBlockIndex = e),
      this.blockDidMutated(_i, this.currentBlock, {
        fromIndex: t,
        toIndex: e,
      });
  }
  ...
  async convert(e, t, o) {
    ...
    if (!s) throw new Error(`Could not convert Block. Tool «${t}» not found.`);
    const n = await e.exportDataAsString(),
      a = q(n, s.sanitizeConfig);
...
class Ri extends y {
  ...
  unSelectBlockByIndex(e) {
    const { BlockManager: t } = this.Editor;
    let o;
    isNaN(e) ? (o = t.currentBlock) : (o = t.getBlockByIndex(e)),
      (o.selected = !1),
      this.clearCache();
  }
  /**
  ...
  clearSelection(e, t = !1) {
    ...
    (this.needToSelectAll = !1),
      (this.nativeInputSelected = !1),
      (this.readyToBlockSelection = !1);
    const n = e && e instanceof KeyboardEvent,
      a = n && kt(e.keyCode);
  ...
  copySelectedBlocks(e) {
    ...
    this.selectedBlocks.forEach((s) => {
      const n = q(s.holder.innerHTML, this.sanitizerConfig),
        a = d.make("p");
...
`),
  ...
  handleCommandA(e) {
    if (
      (this.Editor.RectangleSelection.clearSelection(),
      d.isNativeInput(e.target) && !this.readyToBlockSelection)
    ) {
...
class Ie extends y {
  ...
  get isAtStart() {
    const { currentBlock: e } = this.Editor.BlockManager;
    if (!(e != null && e.focusable)) return !0;
    const t = m.get(),
      o = d.getDeepestNode(e.currentInput);
    let i = t.focusNode;
    if (d.isNativeInput(o)) return o.selectionEnd === 0;
    ...
    return (
      i.nodeType !== Node.TEXT_NODE &&
        ...
        (i.childNodes[n]
          ...
          : ((i = i.childNodes[n - 1]), (n = i.textContent.length))),
      (d.isLineBreakTag(o) || d.isEmpty(o)) &&
      this.getHigherLevelSiblings(i, "left").every((c) => {
        const u = d.isLineBreakTag(c),
          h = c.children.length === 1 && d.isLineBreakTag(c.children[0]),
          f = u || h;
  ...
  get isAtEnd() {
    ...
    if (d.isNativeInput(i)) return i.selectionEnd === i.value.length;
    ...
    if (
      (o.nodeType !== Node.TEXT_NODE &&
        o.childNodes.length &&
        (o.childNodes[s - 1]
          ? ((o = o.childNodes[s - 1]), (s = o.textContent.length))
          : ((o = o.childNodes[0]), (s = 0))),
      d.isLineBreakTag(i) || d.isEmpty(i))
    ) {
      const a = this.getHigherLevelSiblings(o, "right");
      if (
        a.every(
          (c, u) =>
            (u === a.length - 1 && d.isLineBreakTag(c)) ||
            (d.isEmpty(c) && !d.isLineBreakTag(c))
        ) &&
  ...
  setToBlock(e, t = this.positions.DEFAULT, o = 0) {
    ...
    if ((s.clearSelection(), !e.focusable)) {
      (c = window.getSelection()) == null || c.removeAllRanges(),
        s.selectBlock(e),
        (i.currentBlock = e);
      return;
    }
    ...
    if (!n) return;
    const a = d.getDeepestNode(n, t === this.positions.END),
   ...
   */
  set(e, t = 0) {
    const { top: i, bottom: s } = m.setCursor(e, t),
      { innerHeight: n } = window;
    i < 0
      ? window.scrollBy(0, i - 30)
      : s > n && window.scrollBy(0, s - n + 30);
  }
  /**
      ...
      if ((t.deleteContents(), o))
        if (d.isNativeInput(o)) {
          const i = o,
            ...
            n = i.value.substring(0, i.selectionStart),
  ...
  navigateNext(e = !1) {
    ...
    let a = i;
    const l = e || n;
    if (s && l) return this.setToInput(s, this.positions.START), !0;
    if (a === null) {
  ...
  navigatePrevious(e = !1) {
    ...
    if (!t) return !1;
    const { previousInput: i } = t,
      s = e || this.isAtStart;
    return i && s
      ? (this.setToInput(i, this.positions.END), !0)
      : o !== null && s
      ? (this.setToBlock(o, this.positions.END), !0)
      : !1;
  }
  /**
  ...
  createShadow(e) {
    ...
    t.classList.add(Ie.CSS.shadowCaret),
  ...
  insertContentAtCaretPosition(e) {
    const t = document.createDocumentFragment(),
      ...
      s = m.range;
    (o.innerHTML = e),
      Array.from(o.childNodes).forEach((c) => t.appendChild(c)),
      t.childNodes.length === 0 && t.appendChild(new Text());
    const n = t.lastChild;
    s.deleteContents(), s.insertNode(t);
    const a = document.createRange(),
      l = n.nodeType === Node.TEXT_NODE ? n : n.firstChild;
...
class Di extends y {
  ...
  toggleBlockSelectedState(e = !0) {
    ...
    s &&
      (this.lastSelectedBlock.selected !== s.selected
        ? ((s.selected = !0), o.clearCache())
        : ((this.lastSelectedBlock.selected = !1), o.clearCache()),
      (this.lastSelectedBlock = s),
      this.Editor.InlineToolbar.close(),
      s.holder.scrollIntoView({
        block: "nearest",
      }));
  }
  /**
  ...
  clear(e) {
    const { BlockManager: t, BlockSelection: o, Caret: i } = this.Editor,
      ...
      n = t.blocks.indexOf(this.lastSelectedBlock);
    if (
      o.anyBlockSelected &&
      s > -1 &&
      n > -1 &&
  ...
  enableCrossBlockSelection(e) {
    ...
    m.isCollapsed || this.Editor.BlockSelection.clearSelection(e),
...
class Pi extends y {
  ...
  async processDrop(e) {
    ...
    if (s) this.Editor.Caret.setToBlock(s, o.positions.END);
    else {
   ...
   */
  processDragStart() {
    m.isAtEditor && !m.isCollapsed && (this.isStartedAtEditor = !0),
      this.Editor.InlineToolbar.close();
  }
  /**
...
class Fi extends y {
  ...
  constructor({ config: e, eventsDispatcher: t }) {
    super({
      ...
      (this.batchingOnChangeQueue = /* @__PURE__ */ new Map()),
      (this.batchTime = 400),
...
const Vt = class Xt extends y {
  ...
  async processDataTransfer(e, t = !1) {
    ...
    const n = e.getData(this.MIME_TYPE),
    ...
    const c = Object.keys(this.toolsTags).reduce(
        (f, b) => (
          (f[b.toLowerCase()] = this.toolsTags[b].sanitizationConfig ?? {}), f
        ),
        {}
      ),
      u = Object.assign({}, c, o.getAllInlineToolsSanitizeConfig(), { br: {} }),
      h = q(l, u);
    !h.trim() || h.trim() === a || !d.isHTMLString(h)
      ? await this.processText(a)
  ...
  async processText(e, t = !1) {
    const { Caret: o, BlockManager: i } = this.Editor,
    ...
    const a =
      i.currentBlock && i.currentBlock.tool.isDefault && i.currentBlock.isEmpty;
    s.map(async (l, c) => this.insertBlock(l, c === 0 && a)),
  ...
  getPatternsConfig(e) {
    e.pasteConfig === !1 ||
      ...
      K(e.pasteConfig.patterns) ||
      Object.entries(e.pasteConfig.patterns).forEach(([t, o]) => {
        o instanceof RegExp ||
          C(
  ...
  async processFiles(e) {
    const { BlockManager: t } = this.Editor;
    let o;
    (o = await Promise.all(Array.from(e).map((n) => this.processFile(n)))),
      (o = o.filter((n) => !!n));
  ...
  async processFile(e) {
    const t = co(e),
      o = Object.entries(this.toolsFiles).find(
        ([n, { mimeTypes: a, extensions: l }]) => {
          const [c, u] = e.type.split("/"),
            h = l.find((b) => b.toLowerCase() === t.toLowerCase()),
            f = a.find((b) => {
              const [p, k] = b.split("/");
              return p === c && (k === u || k === "*");
            });
    ...
    return (
      ...
      this.getNodes(o)
        .map((s) => {
            ...
            case Node.ELEMENT_NODE:
              (n = s),
                ...
                this.toolsTags[n.tagName] &&
                  (a = this.toolsTags[n.tagName].tool);
              break;
          }
          const { tags: c } = a.pasteConfig || { tags: [] },
            u = c.reduce(
              (b, p) => (
                this.collectTagNames(p).forEach((L) => {
          ...
          } else n.innerHTML = q(n.innerHTML, h);
  ...
  async processSingleBlock(e) {
    const { Caret: t, BlockManager: o } = this.Editor,
      { currentBlock: i } = o;
    if (
      !i ||
      e.tool !== i.name ||
      !d.containsOnlyInlineElements(e.content.innerHTML)
    ) {
  ...
  async processInlinePaste(e) {
    ...
    if (
      ...
      i.textContent.length < Xt.PATTERN_PROCESSING_MAX_LENGTH
    ) {
    ...
    if (t.currentBlock && t.currentBlock.currentInput) {
      ...
      document.execCommand("insertHTML", !1, q(i.innerHTML, n));
   ...
   */
  insertBlock(e, t = !1) {
    const { BlockManager: o, Caret: i } = this.Editor,
      { currentBlock: s } = o;
    let n;
    if (t && s && s.isEmpty) {
  ...
  insertEditorJSData(e) {
    ...
    qe(e, (n) => i.blockTools.get(n).sanitizeConfig).forEach(
      ({ tool: n, data: a }, l) => {
        let c = !1;
        l === 0 &&
          (c =
  ...
  processElementNode(e, t, o) {
    const i = Object.keys(this.toolsTags),
      s = e,
      { tool: n } = this.toolsTags[s.tagName] || {},
      a = this.tagsByTool[n == null ? void 0 : n.name] || [],
      ...
      h = Array.from(s.children).some(({ tagName: f }) =>
        d.blockElements.includes(f.toLowerCase())
      );
  ...
  getNodes(e) {
    ...
    let o;
    const i = (s, n) => {
      if (d.isEmpty(n) && !d.isSingleTag(n)) return s;
      const a = s[s.length - 1];
      let l = new DocumentFragment();
      switch ((a && d.isFragment(a) && (l = s.pop()), n.nodeType)) {
        case Node.ELEMENT_NODE:
          if (((o = this.processElementNode(n, s, l)), o)) return o;
          break;
        case Node.TEXT_NODE:
...
class be extends y {
  ...
  processMouseDown(e) {
    ...
    e.target.closest(d.allInputsSelector) !== null ||
  ...
  changingRectangle(e) {
    ...
    const {
      ...
      n = this.startX < o && this.mouseX < o;
    (this.rectCrossesBlocks = !(s || n)),
    ...
    return new Promise((t) => {
      ...
      if (e.length === 0) i.insert();
        ...
        const s = e.map(({ type: n, data: a, tunes: l, id: c }) => {
          o.available.has(n) === !1 &&
            (X(
              `Tool «${n}» is not found. Check 'tools' property at the Editor.js config.`,
              "warn"
            ),
            (a = this.composeStubDataForTool(n, a, c)),
            (n = o.stubTool));
          let u;
          try {
            u = i.composeBlock({
...
class ji extends y {
  ...
  async save() {
    ...
    try {
      ...
      const s = await Promise.all(i),
        n = await qe(s, (a) => t.blockTools.get(a).sanitizeConfig);
  ...
  makeOutput(e) {
    const t = [];
    return (
      e.forEach(({ id: o, tool: i, data: s, tunes: n, isValid: a }) => {
        if (!a) {
  ...
  constructor({ data: e, config: t, api: o, readOnly: i }) {
    (this.api = o),
      ...
      (this._placeholder = t.placeholder
        ? t.placeholder
        : tt.DEFAULT_PLACEHOLDER),
      (this._data = e ?? {}),
      (this._element = null),
      (this._preserveBlank = t.preserveBlank !== void 0 ? t.preserveBlank : !1);
  }
  /**
  ...
  drawView() {
    ...
    return (
      ...
      this._data.placeholder &&
        (e.dataset.placeholder = this._data.placeholder),
      this.readOnly ||
        ((e.contentEditable = !0), e.addEventListener("keyup", this.onKeyUp)),
      e
    );
  }
  /**
...
class ot {
  ...
  render() {
    return (
      ...
      (this.nodes.button.innerHTML = Qo),
      this.nodes.button
    );
  }
  /**
...
class it {
  ...
  render() {
    return (
      ...
      (this.nodes.button.type = "button"),
      this.nodes.button.classList.add(this.CSS.button, this.CSS.buttonModifier),
      (this.nodes.button.innerHTML = ni),
      this.nodes.button
    );
  }
  /**
...
class st {
  ...
  render() {
    return (
      ...
      (this.nodes.button.type = "button"),
      this.nodes.button.classList.add(this.CSS.button, this.CSS.buttonModifier),
      (this.nodes.button.innerHTML = ut),
      this.nodes.button
    );
  }
  /**
  ...
  checkState() {
    ...
    if (e) {
      (this.nodes.button.innerHTML = di),
...
class qt {
  ...
  make() {
    ...
    return (
      (e.innerHTML = t), o.appendChild(i), o.appendChild(s), e.appendChild(o), e
    );
  }
}
...
var Vi = Object.defineProperty,
  ...
  Zt = (r, e, t, o) => {
    for (
      var i = o > 1 ? void 0 : o ? Xi(e, t) : e, s = r.length - 1, n;
      s >= 0;
      s--
    )
      (n = r[s]) && (i = (o ? n(e, t, i) : n(i)) || i);
...
class nt extends et {
   ...
   */
  get toolbox() {
    const e = this.constructable[re.Toolbox],
...
Zt([de], nt.prototype, "sanitizeConfig", 1);
Zt([de], nt.prototype, "baseSanitizeConfig", 1);
class qi {
  /**
   * @class
   ...
   */
  get(e) {
    const { class: t, isInternal: o = !1, ...i } = this.config[e],
...
class Gt {
  ...
  handleClick() {
    ...
    i.top < window.innerHeight && (s = window.scrollY + o.offsetHeight),
      window.scrollTo(0, s),
...
class Qt {
  ...
  handleClick() {
    ...
    let l;
    a.top > 0
      ? (l = Math.abs(n.top) - Math.abs(a.top))
      : (l = Math.abs(n.top) + a.height),
...
var Zi = Object.defineProperty,
  ...
  Ji = (r, e, t, o) => {
    for (
      var i = o > 1 ? void 0 : o ? Gi(e, t) : e, s = r.length - 1, n;
      s >= 0;
      s--
    )
      (n = r[s]) && (i = (o ? n(e, t, i) : n(i)) || i);
...
class eo extends y {
  ...
  async prepare() {
    if (
      (this.validateTools(),
      (this.config.tools = $e({}, this.internalTools, this.config.tools)),
  ...
  toolPrepareMethodSuccess(e) {
    ...
    if (t.isInline()) {
      const i = ["render", "surround", "checkState"].filter(
        (s) => !t.create()[s]
      );
      if (i.length) {
        C(
  ...
  prepareConfig() {
    ...
    for (const t in this.config.tools)
      D(this.config.tools[t])
        ? (e[t] = this.config.tools[t])
        : (e[t] = { class: this.config.tools[t] });
    return e;
  }
}
Ji([de], eo.prototype, "getAllInlineToolsSanitizeConfig", 1);
...
class ts extends y {
  ...
  get someFlipperButtonFocused() {
    return this.Editor.Toolbar.toolbox.hasFocus()
      ...
      : Object.entries(this.Editor)
          .filter(([e, t]) => t.flipper instanceof J)
  ...
  backspacePressed(e) {
    ...
    if (o.anyBlockSelected && !m.isSelectionExists) {
      const s = t.removeSelectedBlocks(),
        n = t.insertDefaultBlockAtIndex(s, !0);
      i.setToBlock(n, i.positions.START),
        o.clearSelection(e),
        e.preventDefault(),
        e.stopPropagation(),
        e.stopImmediatePropagation();
  ...
  documentClicked(e) {
    ...
    const t = e.target;
    this.nodes.holder.contains(t) ||
      m.isAtEditor ||
      (this.Editor.BlockManager.dropPointer(), this.Editor.Toolbar.close());
    const i =
        (a = this.Editor.BlockSettings.nodes.wrapper) == null
          ? void 0
          : a.contains(t),
      s =
        (l = this.Editor.Toolbar.nodes.settingsToggler) == null
          ? void 0
          : l.contains(t),
      n = i || s;
  ...
  processBottomZoneClick(e) {
    ...
    if (
      ...
      (!a.lastBlock.tool.isDefault || !a.lastBlock.isEmpty) && a.insertAtEnd(),
        l.setToTheLastBlock(),
        c.moveAndOpen(a.lastBlock);
    }
  }
  /**
...
class is {
  ...
  set configuration(e) {
    ...
    D(e)
      ...
      We(!!this.config.holderId, "config.holderId", "config.holder"),
      ...
      this.config.logLevel || (this.config.logLevel = bt.VERBOSE),
      ro(this.config.logLevel),
      We(
    ...
    (this.config.placeholder = this.config.placeholder || !1),
      ...
      (K(this.config.data) ||
        ...
        (this.config.data = { blocks: [t] }),
      (this.config.readOnly = this.config.readOnly || !1),
      (o = this.config.i18n) != null &&
        o.messages &&
        U.setDictionary(this.config.i18n.messages),
      (this.config.i18n.direction =
        ((i = this.config.i18n) == null ? void 0 : i.direction) || "ltr");
  }
  /**
      ...
      (t, o) =>
        t.then(async () => {
          try {
            ...
            if (i instanceof Et) throw new Error(i.message);
